...
![](../results/horse_pops_plot_largest_sd.png){#fig-horse-prov}{width=70%}

#| fig-cap: "Horse populations for the province with the largest standard deviation"

In @fig-horse-prov we zoom in and look at the province of `{python} max_sd_province`, which had the largest spread of values in terms of standard deviation.
